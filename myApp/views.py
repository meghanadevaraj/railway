...
def user_register(request):
    if request.method == 'POST':
        ...
        if User.objects.filter(username=uname).exists():
            ...
            return redirect('myApp:user-register')
    ...
    if request.method == 'POST':
        ...
        if train_no:
            ...
            if train.exists():
                ...
                return render(request, 'AdminCancleTrain.html', {'error_message': 'Train not found.'})
        else:
            return render(request, 'AdminCancleTrain.html', {'error_message': 'Invalid train number.'})
    else:
        return render(request, 'AdminCancleTrain.html')
...
def admin_view_trains(request):
    ...
    return render(request, 'AdminViewTrains.html', context)


def admin_update_train(request):
    context = {}
    return render(request, "AdminUpdateTrain.html", context)

def add_trains(request):
    context = {}
    return render(request, "AdminAddTrains.html", context)
...
def cancle_train(request):
    context = {}
    return render(request, "AdminCancleTrain.html", context)

def admin_search_train(request):
    context = {}
    return render(request, "AdminSearchTrain.html", context)